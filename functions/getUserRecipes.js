...
const getUserRecipes = async (userId) => {
  // Query db for all data related user's saved recipes
  try {
    ...
    // Return object to be used as response object (Message will be generated by controller individual controller functions)
